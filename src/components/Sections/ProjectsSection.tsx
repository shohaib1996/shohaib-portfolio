  ...
  const projects = [
    {
      ...
      technologies: "Next.js, TypeScript, OpenAI API, MongoDB, Express.js",
      category: "AI & Machine Learning",
      challenges: "Integrating AI for real-time form validation, optimizing API response times, ensuring cross-browser compatibility",
    },
    {
      id: 1,
      title: "NeoChat",
      ...
      challenges: "Maintaining WebSocket connection stability, handling large file uploads, implementing end-to-end encryption",
    },
    {
      id: 2,
      title: "MeetHUb",
      ...
      challenges: "Syncing with multiple calendar APIs, managing concurrent bookings, optimizing database queries",
    },
    {
      id: 3,
      title: "DormDineHub",
      ...
      challenges: "Integrating payment gateways, handling high concurrent orders, ensuring menu data consistency",
    },
    {
      id: 4,
      ...
      completionTime: "4 months",
      technologies: "Next.js, TypeScript, MongoDB, Express.js, Stripe",
      category: "E-commerce",
      challenges: "Implementing complex product customization, optimizing image loading, securing payment processing",
    },
  ];
