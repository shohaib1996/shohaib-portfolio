...
export function EducationSection() {
  ...
  const certifications = [
    ...
    },
    {
      ...
      description:
        "Advanced concepts in JavaScript ES6+ and TypeScript for scalable application development.",
    },
    {
      period: "2021-2022",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
            ...
            <motion.div variants={itemVariants}>
              <div className="glowing-border">
                <div className="glowing-border-content bg-background rounded-3xl">
                  <Card className="h-full border border-border rounded-3xl overflow-hidden relative p-[14px]">
                    ...
                    <div className="p-6 relative z-10">
                      <div className="flex items-center mb-6">
                        <div className="p-2 bg-primary/20 rounded-lg mr-3 pulse-glow">
          ...
          <motion.div variants={itemVariants} className="mt-8 text-center">
            ...
            <Card className="border border-border p-6 inset-0 bg-gradient-to-r from-emerald-500/5 via-transparent to-emerald-500/5 dark:from-emerald-400/10 dark:via-transparent dark:to-emerald-400/10 rounded-3xl">
              ...
              <p className="text-muted-foreground max-w-5xl mx-auto leading-relaxed font-mono">
                My journey from Geography & Environmental Science to Full Stack
                Development reflects my passion for continuous learning and
                adaptation. I believe in combining analytical thinking from my
                academic background with modern web development skills to create
